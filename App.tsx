...
// 基础词库 (内置以保证代码运行)
// ==========================================
const HARDCORE_WORDS = ["结构", "映射", "函数", "关系", "集合", "元素", "子集", "并集", "交集", "补集", "顺序", "等价", "分类", "范畴", "态射", "同构", "群论", "环论", "理想", "域论", "向量", "空间", "线性", "变换", "矩阵", "特征", "同态", "自同", "表示", "拓扑", "邻域", "连续", "紧致", "流形", "同调", "同伦", "系统", "涌现", "反馈", "稳态", "信息", "熵值", "噪声", "编码", "解码", "逻辑", "算法", "递归", "优化", "梯度", "公理", "推论", "混沌", "吸引"];
